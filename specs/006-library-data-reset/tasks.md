# Tasks: Library Data Reset

- [x] T001 Add `libraryDisplayStore` with `requestFullReload` (image cache + token)
- [x] T002 Add `useLibraryReloadOnFocus` hook
- [x] T003 Extend `loadLibraries` / `loadSeries` with `{ reset: true }` (clear list, full loader)
